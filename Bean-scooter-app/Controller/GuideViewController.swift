...
class GuideViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = GuideTable.dequeueReusableCell(withIdentifier: Constants.guideCell, for: indexPath) as? GuideTableViewCell else {
        ...
        if indexPath.section == 0 {
            ...
            cell.configure(cellModel: content)
    ...
    override func viewDidLoad() {
        ...
        GuideTable.register(UINib(nibName: Constants.guideTableCell, bundle: nil), forCellReuseIdentifier: Constants.guideCell)
