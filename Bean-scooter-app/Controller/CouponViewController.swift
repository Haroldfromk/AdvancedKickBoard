...
class CouponViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 커스텀 셀 클래스 등록
        collectionView.register(UINib(nibName: Constants.counponCell, bundle: nil), forCellWithReuseIdentifier: Constants.counponCell)
...
extension CouponViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Constants.counponCell, for: indexPath) as! CouponCollectionViewCell
